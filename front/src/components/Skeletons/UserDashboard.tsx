        ...
        <Section styles="bg-black min-h-screen w-full">
            <Container styles="max-w-6xl mx-auto p-6">
                <div className="flex mobile:flex-col md:flex-row gap-6 w-full mb-8 animate-pulse">
                    <div className="flex h-[180px] w-full bg-zinc-900/80 rounded-xl p-6 border border-zinc-800 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgba(139,92,246,0.1)] transition-shadow">
                    ...
                    <div className="flex flex-col items-center justify-center h-[180px] w-full bg-zinc-900/80 rounded-xl p-6 border border-zinc-800 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgba(139,92,246,0.1)] transition-shadow">
