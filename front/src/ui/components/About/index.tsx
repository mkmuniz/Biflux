...
export default function About() {
    const refTextDiv: any = useRef();
    const refImagesDiv: any = useRef();
    const isVisibleTextDiv = useIsVisible(refTextDiv);
    const isVisibleImagesDiv = useIsVisible(refImagesDiv);
